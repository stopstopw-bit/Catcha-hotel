...
const CARDS: CardMeta[] = [
  {
    ...
    styleTexts: [
      ...
      { key: "headerTitle", label: "ป้าย: หัวแถบการ์ด", placeholder: "📅 กำหนดการนัด" },
      { key: "introLine", label: "ป้าย: บรรทัดเปิด", placeholder: "แจ้งกำหนดการนัด 🗓️" },
      { key: "dateLabel", label: "ป้าย: วันที่", placeholder: "วันที่" },
      { key: "timeLabel", label: "ป้าย: เวลา/รายละเอียด", placeholder: "เวลา / รายละเอียด" },
      { key: "programLabel", label: "ป้าย: โปรแกรมอาบน้ำ", placeholder: "โปรแกรมอาบน้ำ" },
      { key: "locationLabel", label: "ป้าย: สถานที่", placeholder: "สถานที่" },
      { key: "notesLabel", label: "ป้าย: หมายเหตุ", placeholder: "หมายเหตุ" },
      { key: "groomServicePrefix", label: "ป้าย: ชื่อบริการ (อาบน้ำ)", placeholder: "อาบน้ำ & กรูมมิ่ง" },
      { key: "roomServicePrefix", label: "ป้าย: ชื่อบริการ (ห้องพัก)", placeholder: "ห้องพัก" },
      { key: "confirmButton", label: "ปุ่ม: ยืนยันนัด", placeholder: "🐾 ยืนยันนัด" },
      { key: "mapButton", label: "ปุ่ม: ดูแผนที่", placeholder: "🗺️ ดูแผนที่ / เส้นทาง" },
    ],
    hasTitleSize: true,
  },
  {
    ...
    styleTexts: [
      { key: "discountLabel", label: "ป้าย: ส่วนลด", placeholder: "ส่วนลด" },
      { key: "netLabel", label: "ป้าย: ยอดสุทธิ", placeholder: "ยอดสุทธิ" },
      { key: "freebiesTitle", label: "ป้าย: หัวข้อของแถม", placeholder: "🎁 ของแถมฟรี" },
      { key: "depositPaidLabel", label: "ป้าย: มัดจำที่ชำระแล้ว", placeholder: "มัดจำที่ชำระแล้ว" },
      { key: "remainingNowLabel", label: "ป้าย: ยอดที่ต้องโอนตอนนี้", placeholder: "ยอดที่ต้องโอนตอนนี้" },
      { key: "remainingLabel", label: "ป้าย: ยอดคงเหลือ", placeholder: "ยอดคงเหลือ" },
      { key: "accountNameLabel", label: "ป้าย: ชื่อบัญชี", placeholder: "ชื่อบัญชี:" },
      { key: "copyButton", label: "ปุ่ม: คัดลอกเลขบัญชี", placeholder: "📋 คัดลอกเลขบัญชี" },
    ],
    hasTitleSize: true,
  },
  {
    ...
    styleTexts: [
      { key: "amountLabel", label: "ป้าย: หัวยอดมัดจำ", placeholder: "มัดจำที่ต้องโอน" },
      { key: "accountNameLabel", label: "ป้าย: ชื่อบัญชี", placeholder: "ชื่อบัญชี:" },
      { key: "copyButton", label: "ปุ่ม: คัดลอกเลขบัญชี", placeholder: "📋 คัดลอกเลขบัญชี" },
    ],
  ...
  },
  {
    ...
    texts: [],
    styleTexts: [
      { key: "headerTitle", label: "ป้าย: หัวแถบการ์ด", placeholder: "🧾 ใบเสร็จรับเงิน" },
      { key: "customerLabel", label: "ป้าย: ลูกค้า", placeholder: "ลูกค้า" },
      { key: "invoiceNoLabel", label: "ป้าย: เลขที่บิล", placeholder: "เลขที่" },
      { key: "paidLabel", label: "ป้าย: หัวยอดที่ชำระ", placeholder: "ชำระแล้ว" },
      { key: "pointsLabel", label: "ป้าย: แต้มที่ได้รับ", placeholder: "🎁 แต้มสะสมที่ได้รับ" },
    ],
  ...
  },
  {
    ...
    styleTexts: [
      { key: "stars", label: "แถวดาวบนหัวการ์ด", placeholder: "⭐ ⭐ ⭐ ⭐ ⭐" },
      { key: "button", label: "ปุ่ม: กดรีวิว", placeholder: "⭐ รีวิวให้เราหน่อยนะคะ" },
    ],
  ...
  },
  {
    ...
    styleTexts: [
      { key: "headerTitle", label: "ป้าย: หัวแถบการ์ด", placeholder: "🩺 ประวัติน้องก่อนอาบน้ำ" },
      { key: "button", label: "ปุ่ม: แจ้งประวัติ", placeholder: "🩺 แจ้งประวัติน้อง" },
    ],
    closingLabel: "ประโยคเสริมท้ายการ์ด (ไม่บังคับ)",
    hasTitleSize: true,
  },
  {
    ...
    styleTexts: [
      ...
      { key: "checkinLabel", label: "ป้าย: วันเข้าพัก", placeholder: "วันเข้าพัก" },
      { key: "roomLabel", label: "ป้าย: ห้องพัก", placeholder: "ห้องพัก" },
    ],
    ...
    texts: [
      {
        ...
        label: "ข้อความในการ์ดเลือกเวลาเข้าพัก (เช็คอิน)",
        multiline: true,
        hint: "ใช้ได้: {shop} {cat} {checkin} {room}",
      },
      {
        stateKey: "checkoutReminder",
        label: "ข้อความในการ์ดเลือกเวลารับน้อง (เช็คเอาท์)",
        multiline: true,
  ...
  },
  {
    ...
    styleTexts: [
      ...
      { key: "usedTodayLabel", label: "ป้าย: ใช้วันนี้", placeholder: "ใช้วันนี้" },
    ],
    closingLabel: "ข้อความปิดท้ายการ์ด (ไม่บังคับ)",
    hasTitleSize: true,
  },
  {
    ...
    styleTexts: [
      ...
      { key: "totalLabel", label: "ป้าย: คำนำหน้ายอดรวม", placeholder: "รวม" },
      { key: "accountNameLabel", label: "ป้าย: ชื่อบัญชี", placeholder: "ชื่อบัญชี:" },
      { key: "copyButton", label: "ปุ่ม: คัดลอกเลขบัญชี", placeholder: "📋 คัดลอกเลขบัญชี" },
      { key: "detailButton", label: "ปุ่ม: ดูรายละเอียด", placeholder: "ดูรายละเอียด" },
    ],
    closingLabel: "ข้อความปิดท้ายการ์ด (ไม่บังคับ)",
    hasTitleSize: true,
  },
  {
    ...
    styleTexts: [
      ...
      { key: "discountLabel", label: "ป้าย: หัวยอดส่วนลด", placeholder: "ส่วนลด" },
